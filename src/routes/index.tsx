        ...
        <div className="relative">
          ...
          {slide && (
            <section className="relative h-[380px] w-full overflow-hidden sm:h-[480px] lg:h-[540px]">
              ...
              <div className="absolute inset-y-0 left-0 z-20 flex max-w-xl flex-col justify-end gap-2 px-3 pb-48 pt-10 sm:pb-52 lg:justify-end lg:gap-3 lg:px-8 lg:pb-36">
